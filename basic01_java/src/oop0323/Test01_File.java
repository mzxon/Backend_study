...
//			String pathName="C:\\Users\\itwill\\Downloads\\20230315_oop.pdf";
...
//				if(file.delete()) System.out.println(filename+"파일 삭제되었습니다!");
//				else System.out.println(filename+"파일 삭제 실패!");
				
				
				//문) 파일명과 확장명을 분리해서 출력하시오
				//	파일명 : 20230315_oop.pdf
				//	확장명 : pdf
			...
			else System.out.println("파일 없어요~!");
