...
public class Test2_String {
	...
	public static void main(String[] args) {
		...
		//문자열의 내용을 비교하는 경우 == 연산자를 사용하지 않고 equals()함수를 이용할 것
	
		if(str.equals(name)) System.out.println("같다");
		else System.out.println("다르다");
		
		//문자열의 갯수가 0인지?
		if(str.isEmpty()) System.out.println("빈문자열이다");
		else System.out.println("빈문자열 아니다.");
		...
		while(st.hasMoreElements()) { //토큰할 문자가 있는지?
				System.out.println(st.nextToken()); //토큰할 문자열 가져오
		}
		////////////////////////////////////////
