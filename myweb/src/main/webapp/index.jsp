  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#"><img src="images/JJ.gif" style="width:30px; margin-bottom:5px;">로그인</a></li>
        <li><a href="#"><img src="images/Jre.gif" style="width:30px; margin-bottom:5px;">포토갤러리</a></li>
